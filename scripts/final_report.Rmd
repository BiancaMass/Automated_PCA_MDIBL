...
params:
  json: "/home/mbianca/Downloads/experiment/data/pipeline_input_file.json"
---
...
Step 7 performs regression of the design equation variable vs each meaningful PC.
...
for (j in 1:length(all_tables)){
  result_table = read.table(file.path(all_tables[i]), header = TRUE, sep = "\t", row.names = 1)
  print(kable(result_table, caption = as.character(all_tables[i])))
}
